...
class BeerRepositoryTest {
    ...
    void testGetBeerListByStyle(){
        Page<Beer> list = beerRepository.findAllByBeerStyleEquals(BeerStyle.LAGER, null);
        assertThat(list.getContent().size()).isEqualTo(39);
    }

    @Test
    void testBeerListByNameAndStyle(){
        Page<Beer> list = beerRepository.findAllByBeerNameIsLikeIgnoreCaseAndBeerStyleEquals("%IPA%", BeerStyle.IPA, null);
